...
public class MainActivity extends AppCompatActivity implements LoaderManager
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            messageTextView.setText(getString(R.string.error_fetching));
            ...
            // Display error
            messageTextView.setText(getString(R.string.error_no_internet));
        }
    }
    ...
    @Override
    public void onLoadFinished(Loader<List<NewsList>> loader, List<NewsList> newsItems) {
        ...
        if (newsItems != null && !newsItems.isEmpty()) {
            ...
            messageTextView.setText(getString(R.string.error_no_articles));
        }
    ...
    public void refreshRecyclerView() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            // Show message text
            messageTextView.setText(getString(R.string.refresh_placeholder));
